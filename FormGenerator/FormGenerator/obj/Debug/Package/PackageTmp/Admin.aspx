        ...
        <asp:Panel ID="pnlAdmin" runat="server" Visible="false">
            ...
            <asp:Panel ID="pnlCreatePage" runat="server" Visible="false">
                <div class="LeftSide">
                    ...
                    <asp:TextBox ID="txtPageName" runat="server" placeholder="Form Name" ToolTip="example: [page name]_blah"></asp:TextBox><br />
                    <asp:Button ID="btnAddPage" runat="server" Text="Add Form" 
            ...
            <asp:Panel ID="pnlAprimoInfo" runat="server" Visible="false">
                <p>Aprimo Info</p>
            ...
            <asp:Panel ID="pnlSetPageFields" runat="server" Visible="false">
                ...
                <asp:Panel ID="pnlEditActions" runat="server" Visible="false">
                    ...
                    <br />
                    <asp:Panel ID="pnlReturnURL" runat="server" Visible="false">
