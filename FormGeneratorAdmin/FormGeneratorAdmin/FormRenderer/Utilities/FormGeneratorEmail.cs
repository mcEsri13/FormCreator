...
namespace Esri.Web.FormGenerator.Utilities
{
    public class FormGeneratorEmail
    {
        public void Send(DataTable dt, string fieldName, string fieldValue, string subject, string aprimoID)
        {
            MailMessage message = new MailMessage();
            string aprimoEmail = "";
            //grabbing from config
            bool isTestMode = Convert.ToBoolean(ConfigurationManager.AppSettings["AprimoTestMode"]);
